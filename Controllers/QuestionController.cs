...
namespace QuestionnaireApi.Controllers
{
    ...
    public class QuestionController : ControllerBase
    {
        private static readonly List<Question> _questions = new List<Question>
        {
            ...
            new Question { Id = 3, Text = "Ваш любимый цвет?", Type = "radio", Options = new List<string> { "красный", "сииний", "«зеленый" } },
            //new Question { Id = 4, Text = "Оцените уровень вашего стресса от 1 до 10", Type = "slider", MinValue = 1, MaxValue = 10 }
        };
